...
func TestServiceTagList(t *testing.T) {
	...
	Convey("TagList", t, func() {
		...
		Convey("When everything goes positive", func() {
			guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "GetTagAll", func(_ *dao.Dao, _ context.Context) ([]*model.Tag, error) {
				return []*model.Tag{{Id: 1}}, nil
			})
			defer guard.Unpatch()
...
func TestServiceCreateTag(t *testing.T) {
	Convey("CreateTag", t, func() {
		...
		Convey("When everything goes positive", func() {
			...
			Convey("Then err should be nil.p1 should not be nil.", func() {
				guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "CreateTag", func(_ *dao.Dao, c context.Context, tag *model.Tag) (int64, error) {
					return 1, nil
				})
				defer guard.Unpatch()
...
func TestServiceUpdateTag(t *testing.T) {
	Convey("UpdateTag", t, func() {
		...
		Convey("When everything goes positive", func() {
			...
			Convey("Then err should be nil.p1 should not be nil.", func() {
				guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "UpdateTag", func(_ *dao.Dao, c context.Context, tag *model.Tag) (int64, error) {
					return 1, nil
				})
				defer guard.Unpatch()
