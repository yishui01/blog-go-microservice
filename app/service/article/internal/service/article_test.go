...
func TestServiceArtList(t *testing.T) {
	Convey("ArtList", t, func() {
		...
		Convey("When everything goes positive", func() {
			guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "ArtMetasList", func(_ *dao.Dao, _ context.Context, _ *model.ArtQueryReq) ([]*model.EsArticle, int64, error) {
				return nil, 0, nil
			})
			defer guard.Unpatch()
...
func TestServiceGetArtBySn(t *testing.T) {
	Convey("GetArtBySn", t, func() {
		...
		Convey("When everything goes positive", func() {
			guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "GetArtBySn", func(_ *dao.Dao, _ context.Context, _ string) (_ *model.Article, _ error) {
				return nil, nil
			})
			...
			guard = monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "GetMetasBySn", func(_ *dao.Dao, c context.Context, sn string) (res *model.Metas, err error) {
				return nil, nil
			})
			defer guard.Unpatch()
...
func TestServiceCreateArt(t *testing.T) {
	Convey("CreateArt", t, func() {
		...
		Convey("testCorrect", func() {
			guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "CreateArtMetas", func(_ *dao.Dao, c context.Context, art *model.Article, metas *model.Metas) (artId int64, err error) {
				return 1, nil
			})
...
func TestServiceUpdateArt(t *testing.T) {
	Convey("UpdateArt", t, func() {
		...
		Convey("testCorrect", func() {
			guard := monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "UpdateArtMetas", func(_ *dao.Dao, c context.Context, art *model.Article, metas *model.Metas) (artId int64, err error) {
				return 1, nil
			})
			guard = monkey.PatchInstanceMethod(reflect.TypeOf(s.dao), "RefreshArt", func(_ *dao.Dao, c context.Context, artId int64) error {
				return nil
